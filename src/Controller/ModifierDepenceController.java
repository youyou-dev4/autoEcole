...
public class ModifierDepenceController implements Initializable {
    ...
    public void initialiserChamps(Depence depence){
        id_depence = depence.getId_depence();
        insererMontant.setText(String.format("%.2f", depence.getMontant()));
        
        motif.setText(depence.getMotif());
   ...
   // Ajouter le versement à la base de données
    ...
    boolean success = gestionnaireVersement.modifierDepence( id_depence,montant,motifValue);
