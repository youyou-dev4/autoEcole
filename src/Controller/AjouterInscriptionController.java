...
public class AjouterInscriptionController implements Initializable {
   ...
   // Ajouter le versement à la base de données
    ...
    boolean success = gestionnaireVersement.ajouterInscription(condidatSelectionne.getId(), montant,permisSelectionne);

    // Vérifier si l'enregistrement a réussi
    if (success) {
        afficherAlerteEtFermerFenetre("Succès", "L'inscription a été enregistré avec succès.", true);
    } else {
        afficherAlerteEtFermerFenetre("Erreur", "Une erreur s'est produite lors de l'enregistrement d'inscription.", false);
    }
}
